...
public class CsrServiceImpl implements CsrService {
    ...
    public CsrResponse reviewCsr(UUID id, ReviewCsrRequest request) {
        ...
        String rejectionReason = request.status() == CsrStatus.REJECTED ? request.rejectionReason() : null;
        ...
        String institutionName = getInstitutionNameById(entity.getInstitutionId());
        return CsrMapper.toResponse(entity, institutionName);
    }
    ...
    private String getInstitutionNameById(UUID institutionId) {
        return institutionService.getInstitutionNameById(institutionId);
    }

    private CsrResponse mapToResponse(Csr entity) {
        String institutionName = getInstitutionNameById(entity.getInstitutionId());
        return CsrMapper.toResponse(entity, institutionName);
    }
